...
let current_users: string[] = ["ishrat", "faraz", "fahad", "anns", "arman"];
let new_users: string[] = ["salman", "shahzaib", "ishrat", "saim", "faraz"];

function listCheck(current_users: string[], new_users: string[]): void {
